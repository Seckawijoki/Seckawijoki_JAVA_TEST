...
public class VertexManager {
	...
	public DirectionalVertex buildAndRegisterVertex(FaceProperty faceProperty) {
		...
		Integer normalID = new Integer(faceProperty.getNormalIndex());
...
//		String globalVertexIdentifier = this.buildGlobalVertexIdentifierFrom(vertexID, textureCoordinateID, normalID);
	...
	private String buildGlobalVertexIdentifierFrom(int vertexID, int textureCoordinateID, int normalID) {
		return vertexID + "." + textureCoordinateID + "." + normalID;
	}
